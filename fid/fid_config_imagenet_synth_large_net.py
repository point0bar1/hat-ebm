...
config = {
  ...
  "exp_name": 'fid_out/imagenet_synth_large_eval',
  ...
  "epsilon": 5e-4,
  "mcmc_temp": 1e-8,
  "update_latents": False,  # for joint learning to True, for synth learning to False
  ...
  # net params
  "gen_factor": 2.0,  # 1.0 for refinement, 2.0 for all other exps
  "ebm_ngf": 2048,  # only used for imagenet exps (1024 for small net, 2048 for large net)
  "gen_ngf": 2048,  # only used for imagenet exps (1024 for small net, 2048 for large net)

  # exp params
  "num_fid_rounds": 520,
  "batch_size": 96,
  "image_dims": [128, 128, 3],  # cifar10: [32, 32, 3], celeb_a [64, 64, 3], imagenet: [128, 128, 3]
