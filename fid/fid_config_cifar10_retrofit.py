...
config = {
  ...
  "exp_name": 'fid_out/cifar10_retrofit_eval',
  ...
  # data type
  "data_type": 'cifar10',  # cifar10, celeb_a, imagenet2012
  "random_crop": False,
  "split": "train",
  ...
  # gen network
  "gen_type": "gen_decoder",  # gen_decoder for retrofit, otherwise gen_sngan
  ...
  "num_fid_rounds": 520,
  "batch_size": 96,
  "image_dims": [32, 32, 3],  # cifar10: [32, 32, 3], celeb_a [64, 64, 3], imagenet: [128, 128, 3]
  "state_dims": [16, 16, 1],  # [16, 16, 1] for retrofit, otherwise [128]
