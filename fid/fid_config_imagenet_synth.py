...
config = {
  ...
  "exp_name": 'fid_out/imagenet_synth_eval',
  ...
  "ebm_ngf": 1024,  # only used for imagenet exps (1024 for small net, 2048 for large net)
  "gen_ngf": 1024,  # only used for imagenet exps (1024 for small net, 2048 for large net)
